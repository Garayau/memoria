...
public:
    ...
    // Public getters y la función resetRegisters
    uint8_t getRegisterValue(uint8_t reg);
    long getFrequencyValue();
...
private:
    ...
    long _frequency; // Miembro para almacenar la frecuencia configurada
    int _power; // Miembro para almacenar la potencia configurada
};
